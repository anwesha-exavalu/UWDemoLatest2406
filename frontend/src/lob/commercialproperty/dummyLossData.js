...
export const tableColumns = {
    priorPolicy: [
        {
            title: 'UW Year', dataIndex: 'uwyear', key: 'uwyear', width: 30,
            fixed: 'left',
            align: 'center',
        },
        {
            title: 'Carrier', dataIndex: 'carrier', key: 'carrier', width: 25,
            fixed: 'left',
            align: 'center',
        },
        {
            title: 'Policy #', dataIndex: 'policyNumber', key: 'policyNumber', width: 145,
            fixed: 'left',
            align: 'center',
        },
        {
            title: 'Effective Date', dataIndex: 'effectiveDate', key: 'effectiveDate', width: 155,
            fixed: 'left',
            align: 'center',
        },
        {
            title: 'Expiration Date', dataIndex: 'expirationDate', key: 'expirationDate', width: 155,
            fixed: 'left',
            align: 'center',
        },
        {
            title: 'Annual Premium', dataIndex: 'annualPremium', key: 'annualPremium', width: 155,
            fixed: 'left',
            align: 'center',
        },
        {
            title: '# Losses', dataIndex: 'losses', key: 'losses', width: 15,
            fixed: 'left',
            align: 'center',
        },
        {
            title: 'Total Loss Amount', dataIndex: 'totalLosses', key: 'totalLosses', width: 100,
            fixed: 'left',
            align: 'center',
        }
    ],
    lossDetail: [
        { title: 'UW Year', dataIndex: 'uwyear', key: 'uwyear',  width: 100,
            fixed: 'left',
            align: 'center', },
        { title: 'Carrier', dataIndex: 'carrier', key: 'carrier',  width: 100,
            fixed: 'left',
            align: 'center', },
        { title: 'Claim #', dataIndex: 'claimNumber', key: 'claimNumber',  width: 140,
            fixed: 'left',
            align: 'center', },
        { title: 'Policy Eff Date', dataIndex: 'effectiveDate', key: 'effectiveDate',  width: 150,
            fixed: 'left',
            align: 'center', },
        { title: 'Policy Exp Date', dataIndex: 'expirationDate', key: 'expirationDate',  width: 150,
            fixed: 'left',
            align: 'center', },
        { title: 'Date of Loss', dataIndex: 'dateofLoss', key: 'dateofLoss',  width: 140,
            fixed: 'left',
            align: 'center', },
        { title: 'Cause of Loss', dataIndex: 'causeofLoss', key: 'causeofLoss',  width: 140,
            fixed: 'left',
            align: 'center', },
        { title: 'LOB', dataIndex: 'lob', key: 'lob',  width: 180,
            fixed: 'left',
            align: 'center', },
        { title: 'LAE', dataIndex: 'lae', key: 'lae',  width: 100,
            fixed: 'left',
            align: 'center', },
        { title: 'Settlement Amount', dataIndex: 'settlementAmount', key: 'settlementAmount',  width: 190,
            fixed: 'left',
            align: 'center', },
        { title: 'Total Incurred', dataIndex: 'totalIncurred', key: 'totalIncurred',  width: 145,
            fixed: 'left',
            align: 'center', },
