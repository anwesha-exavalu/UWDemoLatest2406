...
import { dataColumnsallProducertrust } from "pages/Dashboard/DashboardSubFeatures/dummyData";
...
const Premiumtrust = () => {
  ...
  useEffect(() => {
    const tableObj = tableValues(dataColumnsallProducertrust);
        ...
        <div className="topsection">
          <div>
            <SearchPolicyTitle theme={theme}>
              Premium Trust Deposits Details
            </SearchPolicyTitle>
          </div>
        </div>
          ...
          <FormSection key={group.state} theme={theme}>
            ...
            <Table
              ...
              dataSource={[
                ...
                { key: "3", label: "Total for Agency", value: "$10,000" },
                { key: "4", label: "Total for Batch ID", value: "" },
