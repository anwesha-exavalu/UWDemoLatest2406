...
import SearchPolicyConfig from "./dummyData";
import {
  SearchPolicyTitle,
  SearchPolicySection,
  FormSection,
...
const SearchPolicy = () => {
  ...
  const {dataSource ,columns} = SearchPolicyConfig(viewPolicyDetails,startTransaction)
  return (
      ...
      <Container>
        <div className="topsection">
          <div>
            ...
            <p className="subtext">
            Keep track of renewal dates in the portal, so no one is left unprotected when it
            matters most.
                        </p>
          ...
          <Card>
            <Form layout="vertical">
              <Row gutter={16}>
                ...
                <Col span={6}>
                  <FormControl label="Business Name:" name="businessName" placeholder="" />
                </Col>
                <Col span={6}>
                  <FormControl label="Property Address:" name="propertyAddress" placeholder="" />
                </Col>
                <Col span={6}>
                  <FormControl label="Policy Effective Within:" name="policyEffectiveWithin" placeholder="" />
                </Col>
                <Col span={12}>
        ...
        <FormSection theme={theme}>
           <TableComponent theme={theme} title="Results" columns={columns} data={dataSource} />
        </FormSection>
      </Container>
    </SearchPolicySection>
  );
