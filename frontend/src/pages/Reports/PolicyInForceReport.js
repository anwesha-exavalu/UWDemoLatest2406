...
const PolicyInforceReport = () => {

  const redirectUrl = () => {
    window.open(PDF, '_blank', 'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=800,height=600');
  }
...
export default PolicyInforceReport;